...
namespace tun2socks
{
    ...
    public static class Program
    {
        ...
        public static readonly string ApplicationName = "VEthernet (tun2socks)";
        ...
        {
            Console.Title = Program.ApplicationName;
            ...
            IPEndPoint serverEP = new IPEndPoint(IPAddress.Parse(Environments.GetCommandArgumentString(args, "--proxyserver")),
                Convert.ToInt32(Environments.GetCommandArgumentInt64(args, "--proxyport")));
